...
<div class="articles">
	<p>分类 <!-- <a href="/cate_beta?cate=<?= $cat ?>"> --><font style="font-size:18px;color:#999999;font-weight:bold;"><?= $cate_name ?></font> <!-- </a>  -->下的文章</p>
<?php
...
?>
 ...
 <center>
<?= $tool->pager($p, $page_size, $total_num, '/cate/'.$cid.'/page') ?>
</center>
</div></div>
<!--<script src="https://stat.lgjuzi.com/core/get_code.php?site_id=2"></script>-->
